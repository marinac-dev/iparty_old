defmodule Iparty.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> validate_format(:email, ~r/^[^\s]+@[^\s]+$/,
      message: "E-mail must have the @ sign and no spaces"
    )
    |> validate_length(:email, max: 160)
    |> unsafe_validate_unique(:email, Iparty.Repo)
  ...
  """
  def valid_password?(%Iparty.Accounts.User{hashed_password: hashed_password}, password)
