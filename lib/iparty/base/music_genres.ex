defmodule Iparty.Base.MusicGenres do
  @genres [
    "12-bar blues",
    "2 tone",
    "2-step garage",
  ...
  def search_tags(query) when byte_size(query) >= 3 do
    @genres |> Enum.filter(& String.contains?(&1, query))
  end

  def search_tags(query), do: [query]
end
