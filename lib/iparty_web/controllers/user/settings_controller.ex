defmodule IpartyWeb.User.SettingsController do
  use IpartyWeb, :controller

  alias Iparty.Accounts
  alias IpartyWeb.User.Auth
  @message_update_email "A link to confirm your e-mail change has been sent to the new address."
  ...
  def update_email(conn, %{"current_password" => password, "user" => user_params}) do
    ...
    case Accounts.apply_user_email(user, password, user_params) do
      {:ok, applied_user} ->
        ...
        conn
        |> put_flash(:info, @message_update_email)
