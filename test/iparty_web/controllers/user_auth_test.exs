defmodule IpartyWeb.UserAuthTest do
  use IpartyWeb.ConnCase, async: true

  alias Iparty.Accounts
  alias IpartyWeb.UserAuth
  import Iparty.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, IpartyWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      IpartyWeb.Endpoint.subscribe(live_socket_id)
